...
scp F:\Projects\patient-monitor-datalogger\PatientMonitorDataLogger.*.zip datalogger-rb3bplus:~
ssh datalogger-rb3bplus "./deploy_patient-monitor-datalogger.sh"